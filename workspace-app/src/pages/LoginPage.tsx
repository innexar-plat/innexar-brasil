...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-surface-0">
      <FloatingOrb className="absolute inset-0 opacity-25" orbColor="#06b6d4" />

      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -left-40 -top-40 size-[500px] rounded-full bg-cyan-600/10 blur-3xl" />
        <div className="absolute -bottom-40 -right-40 size-[500px] rounded-full bg-brand-600/10 blur-3xl" />
      </div>
      ...
      >
        <div className="glass-strong rounded-3xl p-8">
          ...
          >
            <div className="mx-auto mb-4 flex size-16 items-center justify-center rounded-2xl bg-cyan-500/15">
              <div className="size-7 rounded-xl bg-gradient-to-br from-cyan-400 to-brand-600" />
            </div>
            <h1 className="text-2xl font-bold text-white">Innexar Workspace</h1>
            <p className="mt-1 text-sm text-slate-400">Acesse o painel interno</p>
          </motion.div>
