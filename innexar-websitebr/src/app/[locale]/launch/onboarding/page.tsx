...
const brStateNames: Record<string, string> = {
...
function OnboardingContent() {
    ...
    // Funções de domínio removidas em favor do redirecionamento para Registro.br
                        ...
                        {currentStep === 1 && (
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    {/* If wants to purchase (.com.br check) */}
                                    {!formData.hasExistingDomain && (
                                            ...
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm text-blue-200/70 mb-3 leading-relaxed">
                                                        {t('onboarding.form.noDomainHelp')}
                                                    </p>
                                                    <a
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        >
                                            <option value="" className="bg-slate-800">Selecione o estado</option>
                                            {brStates.map(state => (
                                                <option key={state} value={state} className="bg-slate-800">{state} - {brStateNames[state]}</option>
                                            ))}
                                        </select>
                                    </div>
                                </div>
